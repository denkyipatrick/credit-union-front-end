...
export class AdminService {
  ...
  public deleteUser(id: string) {
    return this.http.delete<void>(`${this.constantsService.USERS_URL}/${id}`);
  }

  public getUserAccounts(): Observable<object[]> {
    return this.http.get<object[]>(
      `${this.constantsService.USER_ACCOUNTS_URL}`
    );
  }

  public deleteUserAccount(id: string) {
    return this.http.delete<void>(
      `${this.constantsService.USER_ACCOUNTS_URL}/${id}`
    );
  }
  ...
  public setUserPassword(userId: string, pwd: string) {
    return this.http.put(
      `${this.constantsService.USERS_URL}/${userId}/setuserpassword`,
      { password: pwd }
    );
  }
  ...
  public depositAmount(formData: any) {
    return this.http.post<object>(
      `${this.constantsService.TRANSACTIONS_URL}/deposit`,
      formData
    );
  }
  ...
  public withdrawAmount(formData: any) {
    return this.http.post<object>(
      `${this.constantsService.TRANSACTIONS_URL}/withdraw`,
      formData
    );
  }
}
