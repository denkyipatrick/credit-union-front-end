...
export class UtilityService {
  ...
  public getCurrency(currencyId: string) {
    return this.http.get<any>(`${this.constantsService.CURRENCIES_URL}/${currencyId}`);
  }

  public changeCurrencyRate(currencyId: string, rate: number) {
    return this.http.put<any>(`${this.constantsService.CURRENCIES_URL}/${currencyId}`, { rate: rate })
  }
