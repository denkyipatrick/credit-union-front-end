...
export class SigninComponent implements OnInit {
  ...
  signin() {
    ...
    this.utilityService.signin(this.form.value)
    .subscribe(user => {
      ...
      switch(error.status) {
        case 400:
          ...
          break;
        case 404:
          this.errorMessage = 'Your email or phone number could not be found.';
          break;
        case 500:
          this.errorMessage = "Sorry, an unexpected error has occurred. Please try again later.";
          break;
      }
    });
